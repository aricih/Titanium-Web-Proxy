...
namespace Titanium.Web.Proxy.UnitTests.Helpers
{
	...
	public class GZipCompressedByteArray
	{
		...
		private readonly byte[] _gzipCompressedData;
		...
		{
			_gzipCompressedData = data;
		}

		/// <summary>
		/// Gets the value.
		/// </summary>
		public byte[] Value => _gzipCompressedData;

		/// <summary>
		/// Gets the payload.
		/// </summary>
		private byte[] Payload => _gzipCompressedData.SkipWhile((data, index) => index < HeaderLength).ToArray();

		/// <summary>
		/// Gets a value indicating whether this instance is empty.
		/// </summary>
		/// <remarks>Checks magic numbers according to: https://en.wikipedia.org/wiki/Gzip </remarks>
		private bool IsEmpty => _gzipCompressedData.Length == HeaderLength
							   && _gzipCompressedData[0] == 31
							   && _gzipCompressedData[1] == 139
							   && _gzipCompressedData[2] == 8
							   && _gzipCompressedData[3] == 0;
		...
		{
			return _gzipCompressedData.GetHashCode();
		}
	}
