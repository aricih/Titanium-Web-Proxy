...
namespace Titanium.Web.Proxy.Network
{
	...
	public class CertificateMaker
	{
		...
		private static X509Certificate2 GenerateCertificate(string subjectName, string issuerName, DateTime validFrom, DateTime validTo, int keyStrength = 2048, string signatureAlgorithm = "SHA256WithRSA", AsymmetricKeyParameter issuerPrivateKey = null)
		{
			...
			x509Certificate.FriendlyName = ProxyServer.Instance?.RootCertificateFriendlyName ?? ProxyServer.DefaultRootCertificateFriendlyName;
