...
namespace Titanium.Web.Proxy.Helpers
{
	...
	public class FireFoxProxySettingsManager
	{
		...
		/// <summary>
		/// Adds the proxy to firefox configuration.
		/// </summary>
		public void AddProxyToFirefoxConfiguration()
		{
			try
			{
		...
		/// <summary>
		/// Removes the proxy from firefox configuration.
		/// </summary>
		public void RemoveProxyFromFirefoxConfiguration()
		{
			try
			{
				var firefoxProfileDirectory =
